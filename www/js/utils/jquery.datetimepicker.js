		...
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
						...
						.on('mousedown.xdsoft',function() {
							...
							(function arguments_callee4(v) {
								...
								if( $this.hasClass(options.next) && (height-pheight)- options.timeHeightInTimePicker>=top ) {
									...
									//console.log("3 top",(top+options.timeHeightInTimePicker))
								}else if( $this.hasClass(options.prev) && top-options.timeHeightInTimePicker>=0  ) {
									timebox.css('marginTop','-'+(top-options.timeHeightInTimePicker)+'px')
									//console.log("4 top",(top-options.timeHeightInTimePicker))
								}
					...
					.on('afterOpen.xdsoft',function() {
						if( options.timepicker && timebox.find('.xdsoft_current').length ) {
							var pheight = timeboxparent[0].offsetHeight-2,
								...
								//console.log("55 top" ,top)
							if( (height-pheight)<top )
								top = height-pheight;
								//console.log("66 top" ,top)
				...
				var setPos = function() {
					...
					//console.log("77 ",top)
					//console.log("78 ",offset)
					//console.log("79 ",left)
					if( top+datetimepicker[0].offsetHeight>$(window).height() )
						top = offset.top-datetimepicker[0].offsetHeight+1;
					if( left+datetimepicker[0].offsetWidth>$(window).width() )
						left = offset.left-datetimepicker[0].offsetWidth+datetimepicker.data('input')[0].offsetWidth;
					//console.log("80 set css left",left)
					//console.log("80 set css top",top)
					if(top<0){
						top=datetimepicker.data('input').offset().top
						//console.log("my top ",top)
					}
					datetimepicker.css({
						left:left,
						top:top
